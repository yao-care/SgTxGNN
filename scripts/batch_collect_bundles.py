...
import pandas as pd
from sgtxgnn.collectors import DrugBundleAggregator
from sgtxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from sgtxgnn.collectors.drug_bundle import PredictedIndication
    from sgtxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from sgtxgnn.collectors.drug_bundle import DrugBundle
