...
Amorolfine is a morpholine-class antifungal agent widely used as a topical nail lacquer for the treatment of onychomycosis (fungal nail infections).
The TxGNN model predicts it may be effective for **Drug-Induced Osteoporosis**,
however there are currently **0 clinical trials** and **0 publications** supporting this direction — the prediction is supported by computational modelling only.
