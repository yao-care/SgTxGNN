...
- `singapore_regulatory`: HSA registration and market status in the Singapore
...
| Item | Content |
|------|------|
| Original Indication | [Extract from singapore_regulatory.licenses, use first non-empty approved_indication_text] |
...
| Singapore Market Status | [Extract from singapore_regulatory.market_status] |
| Number of Registrations | [Extract from singapore_regulatory.total_licenses] |
...
Extract from `singapore_regulatory.licenses` and create table:

| Authorization Number | Product Name | Dosage Form | Approved Indication |
|---------|------|------|-----------|
| SIN-XXXXX | Product name | Form | Indication summary |
...
| Authorization Number | Product Name | Dosage Form | Approved Indication |
|---------|------|------|-----------|
| SIN-XXXXX | TS-One | Capsule | Gastric cancer, pancreatic cancer, colorectal cancer, NSCLC... |
